...
const itens = [
  ...
  { href: "/metas", rotulo: "Metas de aquisição", rotuloMobile: "Metas", icone: IconeMeta },
  { href: "/investimentos", rotulo: "Investimentos", rotuloMobile: "Investimentos", icone: IconeInvestimento },
